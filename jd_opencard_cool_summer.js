...
入口复制到jd：
29.0复制整段话 http:/JE7uCTwWkguGA8 速来瓜分千万京豆，赢取万元豪礼！￥U6ZvV8bMBa%dakai鯨·=·岽A P/P

============Quantumultx===============
[task_local]
#8.4-8.12 大牌联合 冰爽一夏
21 0,11 * * * jd_opencard_cool_summer.js, tag=8.4-8.12 大牌联合 冰爽一夏, img-url=https://raw.githubusercontent.com/tsukasa007/icon/master/jd_opencard_cool_summer.png, enabled=true

================Loon==============
[Script]
cron "21 0,11 * * *" script-path=jd_opencard_cool_summer.js,tag=8.4-8.12 大牌联合 冰爽一夏

===============Surge=================
8.4-8.12 大牌联合 冰爽一夏 = type=cron,cronexp="21 0,11 * * *",wake-system=1,timeout=3600,script-path=jd_opencard_cool_summer.js

============小火箭=========
8.4-8.12 大牌联合 冰爽一夏 = type=cron,script-path=jd_opencard_cool_summer.js, cronexpr="21 0,11 * * *", timeout=3600, enable=true
*/
...
!(async () => {
    ...
    $.shareUuid = '5fac14ef61f74a2497cc88e7bdc37632'
