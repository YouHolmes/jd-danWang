...
# 领券中心签到
5 1,17 * * * node /scripts/jd_ccSign.js >> /scripts/logs/jd_ccSign.log 2>&1
# 东东超市兑换奖品
...
# 京豆变动通知all
12 21 * * * node /scripts/jd_bean_change_all.js >> /scripts/logs/jd_bean_change_all.log 2>&1
# 京东排行榜
...
# 京东抽奖机
22 0,6,17 * * *  node /scripts/jd_lotteryMachine.js >> /scripts/logs/jd_lotteryMachine.log 2>&1
# 京东摇一摇
