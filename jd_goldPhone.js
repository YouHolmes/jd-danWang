...
!(async () => {
    ...
    /*try{res = await getAuthorShareCode('https://raw.githubusercontent.com/asd920/updateTeam/main/shareCodes/jd_jinji.json');}catch (e) {}
    if(!res){
        try{res = await getAuthorShareCode('https://raw.fastgit.org/asd920/updateTeam/main/shareCodes/jd_jinji.json');}catch (e) {}
        if(!res){res = [];}
    }
    if(res && res.length > 0){
